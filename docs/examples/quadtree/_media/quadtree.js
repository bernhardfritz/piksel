...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'quadtree.data';
    var REMOTE_PACKAGE_BASE = 'quadtree.data';
...
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_quadtree.data');

    };
    Module['addRunDependency']('datafile_quadtree.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 0, "filename": "/data/dummy"}, {"start": 0, "audio": 0, "end": 0, "filename": "/data/placeholder.txt"}], "remote_package_size": 0, "package_uuid": "6cb34d08-0f94-4d35-aa4e-b14e26d61355"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'quadtree.wast';
  var wasmBinaryFile = 'quadtree.wasm';
  var asmjsCodeFile = 'quadtree.temp.asm.js';
...
Module['wasmTableSize'] = 1376;

Module['wasmMaxTableSize'] = 1376;
...
var real___GLOBAL__sub_I_quadtree_cpp = asm["__GLOBAL__sub_I_quadtree_cpp"]; asm["__GLOBAL__sub_I_quadtree_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_quadtree_cpp.apply(null, arguments);
};

var real___GLOBAL__sub_I_xy_cpp = asm["__GLOBAL__sub_I_xy_cpp"]; asm["__GLOBAL__sub_I_xy_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_xy_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_quadtree_cpp = Module["__GLOBAL__sub_I_quadtree_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_quadtree_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_xy_cpp = Module["__GLOBAL__sub_I_xy_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_xy_cpp"].apply(null, arguments) };
