...
STATICTOP = STATIC_BASE + 18480;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_main_cpp() } }, { func: function() { __GLOBAL__sub_I_app_cpp() } }, { func: function() { __GLOBAL__sub_I_astar_cpp() } }, { func: function() { __GLOBAL__sub_I_baseapp_cpp() } }, { func: function() { __GLOBAL__sub_I_graphics_cpp() } }, { func: function() { __GLOBAL__sub_I_SignedDistance_cpp() } });
...
var real___GLOBAL__sub_I_astar_cpp = asm["__GLOBAL__sub_I_astar_cpp"]; asm["__GLOBAL__sub_I_astar_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_astar_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_astar_cpp = Module["__GLOBAL__sub_I_astar_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_astar_cpp"].apply(null, arguments) };
