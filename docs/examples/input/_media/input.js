...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'input.data';
    var REMOTE_PACKAGE_BASE = 'input.data';
...
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_input.data');

    };
    Module['addRunDependency']('datafile_input.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 0, "filename": "/data/dummy"}], "remote_package_size": 0, "package_uuid": "3a372dc1-85f2-48ff-a3fe-03e0fbdef56b"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'input.wast';
  var wasmBinaryFile = 'input.wasm';
  var asmjsCodeFile = 'input.temp.asm.js';
...
STATICTOP = STATIC_BASE + 31648;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_main_cpp() } }, { func: function() { __GLOBAL__sub_I_app_cpp() } }, { func: function() { __GLOBAL__sub_I_baseapp_cpp() } }, { func: function() { __GLOBAL__sub_I_graphics_cpp() } }, { func: function() { __GLOBAL__sub_I_SignedDistance_cpp() } }, { func: function() { __GLOBAL__sub_I_base64_cpp() } });
