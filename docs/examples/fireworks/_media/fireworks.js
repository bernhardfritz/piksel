...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'fireworks.data';
    var REMOTE_PACKAGE_BASE = 'fireworks.data';
...
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_fireworks.data');

    };
    Module['addRunDependency']('datafile_fireworks.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 0, "filename": "/data/dummy"}], "remote_package_size": 0, "package_uuid": "48a83bec-128a-4b74-aa57-ec6ca01cb512"});
...
function integrateWasmJS() {
  var wasmBinaryFile = 'fireworks.wasm';
